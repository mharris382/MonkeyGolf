...
#include "PCGSaveCourseMeshToAsset.generated.h"

/**
* Saves dynamic mesh data into a static mesh asset.
*/
UCLASS(MinimalAPI, BlueprintType, ClassGroup = (Procedural))
class UPCGSaveCourseMeshToAssetSettings : public UPCGDynamicMeshBaseSettings
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = Settings, meta = (PCG_Overridable))
	TObjectPtr<UMaterialInterface> SlopeMaterial;
};

class FPCGSaveCourseMeshToAssetElement : public IPCGElement
{
public:
