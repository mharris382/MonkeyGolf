...
#include "PCGCourseSplineToMesh.generated.h"

UCLASS(MinimalAPI, BlueprintType, ClassGroup = (Procedural))
class UPCGCourseSplineToMeshSettings : public UPCGDynamicMeshBaseSettings
{
	GENERATED_BODY()
...
class FPCGCourseSplineToMeshElement : public IPCGDynamicMeshBaseElement
{
protected:
