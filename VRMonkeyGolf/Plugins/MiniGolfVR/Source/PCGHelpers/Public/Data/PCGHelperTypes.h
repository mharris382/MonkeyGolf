...
struct PCGHELPERS_API FPCGSurfaceSampleSettings
{
	GENERATED_BODY();
...
USTRUCT(BlueprintType)
struct PCGHELPERS_API FTransformRandomSettings
{
	GENERATED_BODY();
...
USTRUCT(BlueprintType)
struct PCGHELPERS_API FSimpleGrammarModule
{
	GENERATED_BODY();
